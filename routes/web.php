...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    //Masters - Customer
    Route::view('/master/customer/create', 'master.customer.create')->name('customer.create');
    ...
    //Masters - Site
    Route::view('/master/site/create', 'master.site.create')->name('site.create');
    ...
    //Masters - Labor
    Route::view('/master/labor/create', 'master.labor.create')->name('labor.create');
